...
// $contact_id = $contactDAO->create(new Contacts(0, 'test1', 'test1', 'test1', 'test1'));
...
// $commentDAO->create(new Comments(0, "test3", "29.03.2024", "test1"));
// $commentDAO->create(new Comments(0, "test4", "20.03.2024", "test2"));
// $commentDAO->create(new Comments(0, "test5", "15.03.2024", "test3"));
// var_dump($post);
// echo "<br><br>";
