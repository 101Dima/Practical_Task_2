<?php
    ...
    class AuthorsDAO extends DAO
    {
        ...
        {
            $sql = "INSERT INTO `author_books` (`authors_id`, `books_id`) 
        ...
        public function getBooks(int $authors_id) : array
        {
            $sql = "SELECT `books`.* FROM `books` 
                    INNER JOIN `author_books` ON `author_books`.`books_id` = `books`.`books_id` 
                    WHERE `author_books`.`authors_id` = '{$authors_id}'";
